    ...
    if xml_tools:
        lines.extend(
            [
                ...
                "- When a parameter's schema type is array or object, its value must be raw JSON starting with [ or { (or use repeated <item> tags). Never wrap it in extra quotes: a quoted JSON string like \"[{...}]\" is invalid and will be rejected.",
